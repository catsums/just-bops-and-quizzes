...
function loadEvents() {
  ...
  function createConductor() {
    ...
    conductor.connectElements([
      (0, import_jquery2.default)(".splashLogo")[0],
      (0, import_jquery2.default)(".disclaimer")[0],
      (0, import_jquery2.default)("#coolSplashText")[0],
  ...
  (0, import_jquery2.default)(".splashLogo").on("beatHit", (event) => {
    let e = event;
  ...
  (0, import_jquery2.default)(".disclaimer").on("beatHit", (event) => {
    let e = event;
  ...
  (0, import_jquery2.default)("#coolSplashText").on("beatHit", (event) => {
    let e = event;
    var obj = e.currentTarget;
    var animBox = (0, import_animejs2.default)({
      targets: obj,
  ...
  (0, import_jquery2.default)(".songPlayButton").on("click", onSongTogglePlay);
  (0, import_jquery2.default)(".splashLogo").on("click", onSongTogglePlay);
  function onSongTogglePlay(event) {
    let e = event;
    var btn = (0, import_jquery2.default)(".songPlayButton")[0];
    if (!songIsPlay) {
  ...
  __name(onSongTogglePlay, "onSongTogglePlay");
  (0, import_jquery2.default)(".scrollUp").on("click", (e) => {
    (0, import_jquery2.default)("#containerL")[0].scrollTo({
      top: 0,
      left: 0,
      behavior: "smooth"
    });
    (0, import_jquery2.default)(".scrollUp").html(``);
    (0, import_jquery2.default)(".scrollDown").html("Click here for more info");
  });
  (0, import_jquery2.default)(".scrollDown").on("click", (e) => {
    (0, import_jquery2.default)("#containerL")[0].scrollTo({
      top: 1e3,
      left: 0,
      behavior: "smooth"
    });
    (0, import_jquery2.default)(".scrollUp").html("Click here to return to player");
    (0, import_jquery2.default)(".scrollDown").html("");
  });
  (0, import_jquery2.default)(".goToSignupBtn").on("click", (e) => {
    (0, import_jquery2.default)("#containerR")[0].scrollTo({
      top: 0,
      left: 0,
      behavior: "smooth"
    });
  });
  (0, import_jquery2.default)(".goToLoginBtn").on("click", (e) => {
    (0, import_jquery2.default)("#containerR")[0].scrollTo({
      top: 1e3,
      left: 0,
      behavior: "smooth"
  ...
  function playRandomSong() {
    ...
    (0, import_jquery2.default)(".songTitleCol").html(currSong.title);
    (0, import_jquery2.default)(".songArtistCol").html(currSong.author);
    var audio = (0, import_jquery2.default)("#conductorAudio")[0];
  ...
  function playDefaultSong() {
    ...
    (0, import_jquery2.default)(".songTitleCol").text(currSong.title);
    (0, import_jquery2.default)(".songArtistCol").text(currSong.author);
    var audio = (0, import_jquery2.default)("#conductorAudio")[0];
  ...
  (0, import_jquery2.default)(".loginRing").click(function(event) {
  ...
  (0, import_jquery2.default)(".signUpBtn").on("click", (event) => {
    var url = "/signup";
    var form = (0, import_jquery2.default)(
      `<form action="${url}" method="get" style="display:none;">
				<input type="text" name="email" value="${(0, import_jquery2.default)("#email")[0].value}" />
			</form>`
    );
    (0, import_jquery2.default)("body").append(form);
    form.submit();
  });
}
