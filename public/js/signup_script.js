...
function main() {
  ...
  if (urlParams?.email) {
    ...
    let emailElem = (0, import_jquery2.default)('input[name="email"]')[0];
    if (emailElem) {
      emailElem.value = _email;
    }
  }
  (0, import_jquery2.default)("#confirmPassword")[0].onchange = (event) => {
    verifyPasswords(event);
  };
  (0, import_jquery2.default)("#password")[0].onchange = (event) => {
    verifyPasswords(event);
  };
  (0, import_jquery2.default)(".signupRing").on("click", (event) => {
  ...
  function verifyPasswords(e) {
    var passElem = (0, import_jquery2.default)("#password")[0];
    var confirmPassElem = (0, import_jquery2.default)("#confirmPassword")[0];
  ...
  __name(verifyPasswords, "verifyPasswords");
  function checkIfPasswordsAreMatching() {
    var pass = (0, import_jquery2.default)("#password")[0].value;
    var confirmPass = (0, import_jquery2.default)("#confirmPassword")[0].value;
    if (confirmPass == pass)
      return true;
    return false;
  }
  __name(checkIfPasswordsAreMatching, "checkIfPasswordsAreMatching");
