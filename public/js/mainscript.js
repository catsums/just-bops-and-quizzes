...
__export(mainscript_exports, {
  ...
  createMenuTracker: () => createMenuTracker,
  deletePopUp: () => deletePopUp,
  displayPopUpBox: () => displayPopUpBox,
  easyPopUpBox: () => easyPopUpBox,
  ...
  setSlidableContent: () => setSlidableContent,
  transitionTo: () => transitionTo
});
module.exports = __toCommonJS(mainscript_exports);
